 ...
 */
export function generateBullMarketReport(): void {
    console.log(chalk.green.bold('🟢 BULL MARKET ANALYSIS REPORT'));
    ...
    const bullScenarios: TestScenario[] = [
        {
    ...
    console.log(chalk.green.bold('🚀 BULL MARKET SCENARIO ANALYSIS'));
    console.log('='.repeat(60));
    ...
    bullScenarios.forEach((scenario, index) => {
        ...
        try {
            ...
            const transitionData1: PriceData = {
                crypto: [
            ...
            const transitionData2: PriceData = {
                crypto: [
