...
/**
 * Real Market Test with Updated Thresholds (0.05% and -0.05%)
 * Tests live market data with the new sensitive threshold configuration
 */
...
async function realMarketTest() {
    console.log(chalk.cyan.bold('🌍 REAL MARKET TEST - LIVE DATA'));
    console.log('='.repeat(60));
    console.log('Date: ' + new Date().toLocaleDateString());
    console.log('Time: ' + new Date().toLocaleTimeString());
    console.log('Test Type: Live Market Data with Updated Thresholds\n');
    ...
    try {
        ...
        for (let i = 1; i <= 5; i++) {
            ...
            try {
                ...
                const freshPriceResponse = await fetchPrices();
        ...
        console.log('• Tested with ultra-sensitive thresholds (0.05% / -0.05%)');
